...
type Cookie struct {
	...
	RotationSecret string        `flag:"cookie-rotation-secret" cfg:"cookie_rotation_secret"`
...
func cookieFlagSet() *pflag.FlagSet {
	...
	flagSet.String("cookie-rotation-secret", "", "the seed string for secure cookies (optionally base64 encoded)")
